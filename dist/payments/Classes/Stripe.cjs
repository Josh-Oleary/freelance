...
const stripe = require('stripe')('sk_test_51MOWifKEvKjZ4LBEH6ctGv99J51NiIY9Fqhf6opJ6i5YFOBQ1RRHt7lMvR5EHnvsN0evruw1KsyEFTvBUEiiD73b00idMytLiz'); // es-lint disable-line
class Stripe {
    constructor() { }
    ...
    static createPortalSession(checkoutSession) {
        return __awaiter(this, void 0, void 0, function* () {
            const portalSession = yield stripe.billingPortal.session.create({
